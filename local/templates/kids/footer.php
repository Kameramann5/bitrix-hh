    ...
    <div class="container" >
        <div class="row" style="position: relative">
            <div class=" col-lg-5 logo">
                <?$APPLICATION->IncludeFile(SITE_DIR."include/kids/footer/logo.php", [], ["NAME" => "лого", "TEMPLATE" => "file_inc.php"])?>
        ...
        <div class="footer_bottom">
            ...
            <div class="direkt">
                <?$APPLICATION->IncludeFile(SITE_DIR."include/kids/footer/dev.php", [], ["NAME" => "разработка", "TEMPLATE" => "file_inc.php"])?>
            </div>
        </div>
